...
export function Contact() {
  return (
    <Section id="contact" className="bg-[var(--bg-secondary)]">
      <div className="mx-auto max-w-2xl text-center">
        <FadeUp>
          ...
          <p className="mt-4 text-base text-[var(--text-secondary)] md:text-lg">
            Have a project in mind? Want to partner up? Or just want to say
        ...
        <FadeUp delay={0.25}>
          <div className="mt-8 flex items-center justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm text-[var(--text-secondary)] transition-colors hover:bg-[var(--surface-hover)] hover:text-[var(--text-primary)]"
            >
              <svg
                viewBox="0 0 24 24"
                width="18"
